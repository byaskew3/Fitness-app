...
function AddActivity(props) {
    ...
    // Add the activity to firebase through API
    const handleSubmit = () => {
        if (authUser) {
            ...
            setSnackbarMsg('Added exercise to your log!');
            setTimeout(() => {
            ...
            <FormControl className={classes.formControl}>
                ...
                <div style={{marginTop: '20px', marginBottom: '30px'}}>
                    ...
                    <Select
                        ...
                        onChange={handleChange}
                    >
                        <MenuItem value={1}>Resistance</MenuItem>
                        <MenuItem value={2}>Cardio</MenuItem>
                        <MenuItem value={3}>Resistance + Cardio</MenuItem>
                    </Select>
                </div>
                <Typography id="discrete-slider" gutterBottom>
                    Duration
